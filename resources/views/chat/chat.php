        ...
        <div class="card-body">
            <form id="form-choose-room">
                <div class="form-group">
                    ...
                    <input type="text" id="input-name" name="name" value="<?= $room['user'] ?>"
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="form-send-message">
                <textarea rows="3" id="textarea-send-message" name="message" class="form-control"
...
<script src="<?= url('assets/js/linkify.min.js') ?>"></script>
<script src="<?= url('assets/js/linkify-string.min.js') ?>"></script>
<script src="<?= url('assets/js/site/chat.js') ?>"></script>
<script src="<?= url('assets/js/site/typing-status.js') ?>"></script>