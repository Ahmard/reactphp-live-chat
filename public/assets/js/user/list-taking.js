...
const initLinkPreview = function () {
    // Link preview
    $('.list-taking-item-content').off('mouseover').on('mouseover', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (imageAddress && imageAddress.trim()) {
                        ...
                        listTakingItem.attr('title', 'No preview available');
                    }
